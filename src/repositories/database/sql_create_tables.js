...
INSERT INTO pessoas (idPessoa, nome, cpf,dataNascimento ) VALUES (1, 'Vinicius Benício Carvalho', '768.744.468-00', '1985-09-11');

INSERT INTO tipoConta (idTipoConta , nome ) VALUES (1, 'PF - Conta Corrente');

INSERT INTO tipoConta (idTipoConta , nome ) VALUES (2, 'PF - Conta Poupança');

INSERT INTO tipoConta (idTipoConta , nome ) VALUES (3, 'PJ - Conta Corrente');
